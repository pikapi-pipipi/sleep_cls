...
class OneFoldTrainer:
    def __init__(self, args, fold, config):
        ...
        # self.scheduler = WarmupCosineAnnealingStepLR(self.optimizer, warmup_steps=warmup_steps, total_steps=total_steps, target_lr=target_lr, min_lr=min_lr, T_mult=2)
    ...
    def build_dataloader(self):
        ...
        val_loader = DataLoader(dataset=val_dataset, sampler=val_sampler, batch_size=self.tp_cfg['batch_size'], shuffle=False, num_workers=8, pin_memory=True)
